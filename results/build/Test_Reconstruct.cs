...
// Command-line arguments: build src/Test_Reconstruct.dfy src/Common.dfy src/QuotientGraph.dfy -o results/build/Test_Reconstruct
// the_program
...
module Test_Reconstruct {
  method Main(_noArgsParameter: seq<seq<char>>)
  {
    ...
    var E: set<Edge> := {Edge(vB, vN, Translation(0, 0, 0)), Edge(vB, vN, Translation(1, 0, 0)), Edge(vB, vN, Translation(1, 1, 0))};
    var atoms, bonds := ReconstructMolecule(V, E);
    assert BaseAtoms(V) == {Atom(""B"", 1, Translation(0, 0, 0)), Atom(""N"", 2, Translation(0, 0, 0))};
    assert TranslatedAtoms(E) == {Atom(""N"", 2, Translation(1, 0, 0)), Atom(""N"", 2, Translation(1, 1, 0))};
    assert |atoms| == 4;
...
namespace Test__Reconstruct {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Common._IVertex _0_vB;
      _0_vB = Common.Vertex.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("B"), BigInteger.One);
      Common._IVertex _1_vN;
      _1_vN = Common.Vertex.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("N"), new BigInteger(2));
      Dafny.ISet<Common._IVertex> _2_V;
      _2_V = Dafny.Set<Common._IVertex>.FromElements(_0_vB, _1_vN);
      Dafny.ISet<Common._IEdge> _3_E;
      _3_E = Dafny.Set<Common._IEdge>.FromElements(Common.Edge.create(_0_vB, _1_vN, Common.Translation.create(BigInteger.Zero, BigInteger.Zero, BigInteger.Zero)), Common.Edge.create(_0_vB, _1_vN, Common.Translation.create(BigInteger.One, BigInteger.Zero, BigInteger.Zero)), Common.Edge.create(_0_vB, _1_vN, Common.Translation.create(BigInteger.One, BigInteger.One, BigInteger.Zero)));
      Dafny.ISet<Common._IAtom> _4_atoms;
      Dafny.ISet<Common._IBond> _5_bonds;
      Dafny.ISet<Common._IAtom> _out0;
      Dafny.ISet<Common._IBond> _out1;
      QuotientGraph.__default.ReconstructMolecule(_2_V, _3_E, out _out0, out _out1);
      _4_atoms = _out0;
      _5_bonds = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Reconstruct:  #atoms=")).ToVerbatimString(false));
      Dafny.Helpers.Print((new BigInteger((_4_atoms).Count)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("  #bonds=")).ToVerbatimString(false));
      Dafny.Helpers.Print((new BigInteger((_5_bonds).Count)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
} // end of namespace Test__Reconstruct
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => Test__Reconstruct.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
